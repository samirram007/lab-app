            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                      ...
                      data-url="{{ route('addemployee') }}" data-size="md" title="Edit Area" class="load-popup btn btn-primary mx-2  "> 
                          ...
                          <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{  $item['Address'] }}</td>
                                    <td>{{  $item['DOJ'] }}</td>
                                    <td>{{  $item['IsCollector'] }}</td>
                                    <td>{{  $item['Origin'] }}</td>
                                    <td><div class="edit-icon">
                                    
<?php $service['EmployeeID']=$item['UserID'] ?>
<?php $service['EmployeeData']=$item ?>
{{-- {{ $service['EmployeeData']=$item }} --}}
              <a href="javascript:;" data-real="{{ $item['UserID'] }}" 
              data-param="{{openssl_encrypt(json_encode($item),"AES-128-ECB",md5(env('ENC_SALT'))) }}" 
              data-url="{{ route('addemployee') }}" data-size="md" title="Edit Area" 
