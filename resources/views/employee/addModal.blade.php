        ...
        <div class="modal-content bg-secondary">
          ...
          <div class="modal-body bg-light">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="Name" id="Name" placeholder="Employee Name" value="{{ $Name }}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="DOJ" id="DOJ" placeholder="DOJ" value="{{ $DOJ }}">
              </div>
              <div class="form-group">
                <label for="IsCollector">IsCollector</label>
                <input type="text" class="form-control" name="IsCollector" id="IsCollector" placeholder="IsCollector" value="{{ $IsCollector }}">
              </div>
              <div class="form-group">
