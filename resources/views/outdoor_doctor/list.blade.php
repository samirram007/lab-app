            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                      ...
                      data-url="{{ route('addoutdoor_doctor') }}" data-size="md" title="Edit Area" class="load-popup btn btn-primary mx-2  "> 
...
<?php $service['Outdoor_doctorID']=$item['UserID'] ?>
<?php $service['Outdoor_doctorData']=$item ?>
{{-- {{ $service['Outdoor_doctorData']=$item }} --}}
              <a href="javascript:;" data-real="{{ $item['UserID'] }}" 
              data-param="{{openssl_encrypt(json_encode($item),"AES-128-ECB",md5(env('ENC_SALT'))) }}" 
              data-url="{{ route('addoutdoor_doctor') }}" data-size="md" title="Edit Area" 
