            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                      ...
                      data-url="{{ route('addvisitappoint') }}" data-size="md" title="Edit Area" class="load-popup btn btn-primary mx-2  "> 
                          ...
                          <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{  $item['Active'] }} </td>  
                                    <td>{{  $item['OutdoorDept'] }} </td>                                                               
                                    <td><div class="edit-icon">
                                    
<?php $service['VisitAppointID']=$item['MasterID'] ?>
<?php $service['VisitAppointData']=$item ?>
{{-- {{ $service['VisitAppointData']=$item }} --}}
              <a href="javascript:;" data-real="{{ $item['MasterID'] }}" 
              data-param="{{openssl_encrypt(json_encode($item),"AES-128-ECB",md5(env('ENC_SALT'))) }}" 
              data-url="{{ route('addvisitappoint') }}" data-size="md" title="Edit Area" 
...
data-url="{{ route('addvisitappoint') }}" data-size="md" title="Edit Area"  class="load-popup btn btn-primary ml-1"><i class="fas fa-plus"></i> Service</a>
