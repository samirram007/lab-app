        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                  ...
                  data-url="{{ route('addproduct') }}" data-size="md" title="Edit Area" class="load-popup btn btn-primary mx-2  "> 
          ...
          data-url="{{ route('addproduct') }}" data-size="md" title="Edit Area" class="load-popup text-white edit-btn btn btn-info">
          <i class="fas fa-pencil-alt"></i></a>

          <a href="javascript:;" data-real="{{ $item['MasterID'] }}" 
          data-param="{{openssl_encrypt(json_encode($item),"AES-128-ECB",md5(env('ENC_SALT'))) }}" 
          data-url="{{ route('includeproduct') }}" data-size="md" title="Edit Area" class="load-popup text-white ml-2 edit-btn btn btn-primary">
