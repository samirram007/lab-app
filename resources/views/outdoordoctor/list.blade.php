            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                ...
                <ol class="breadcrumb float-sm-right">
                  {{-- <!--li class="breadcrumb"><a class="btn btn-primary mx-2" href="{{ route('outdoordoctor-page')}}"><i class="fas fa-plus mx-1"></i>New</a></li--> --}}
                  <li class="breadcrumb">
                    
                    {{-- <!--a   href ="{{ route('addoutdoordoctor') }}"  class="btn btn-primary mx-2" data-toggle="modal" data-target="#modalAddProduct"--> --}}
